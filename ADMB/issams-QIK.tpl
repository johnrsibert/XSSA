GLOBALS_SECTION;
  ...
  const double LOG_M_PI = log(M_PI);
   ...
   //  issams-QIK -noinit -iprint 1 -shess &> issams.out&
   //  issams-QIK -noinit -mcmc2 500000 -mcsave 20 -shess &> issams.out
...
PROCEDURE_SECTION
  ...
  step0(U(utPop+1), logsdlogProc, logr, logQ);
  //TRACE(nll)
...
SEPARABLE_FUNCTION void step0(const dvariable& p11, const dvariable& lsdlogProc, const dvariable& lr, const dvariable& tlogQ)
...
SEPARABLE_FUNCTION void step(const int t, const dvar_vector& f1, const dvar_vector& f2, const dvariable& p11, const dvariable p12, const dvariable& lsdlogProc, const dvariable& lr, const dvariable lnQ)
  ...
  dvariable K = Q*immigrant_biomass(t);
