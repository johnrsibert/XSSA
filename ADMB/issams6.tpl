...
DATA_SECTION
  ...
  init_int phase_sdlogBProc;
  init_number init_sdlogBProc;
  !! TTRACE(init_sdlogBProc,phase_sdlogBProc)
...
SEPARABLE_FUNCTION void step0(const dvariable& p11, const dvariable& lsdlogBProc, const dvariable& lFmsy, const dvariable& lMSY, const dvariable& lgtQ)
  ...
  dvariable p10 = log(K);
  dvariable lsdlogPop = lsdlogBProc;
...
FUNCTION void write_status(ofstream& s)
    ...
    s << "#    K = " << K << endl;
    s << "#   logsdlogBProc: " << logsdlogBProc
             <<  " (" << active(logsdlogBProc) <<")" << endl;
    s << "#      sdlogBProc: " << mfexp(logsdlogBProc) << endl;
