...
DATA_SECTION
  ...
  init_int use_PropL_prior;
  init_number PropL_start_time;
  init_number PropL_prior;
  init_number sdPropL_prior;
  number LPropL_prior;
  number varLPropL_prior;
  !! TTRACE(use_PropL_prior,PropL_start_time)
  !! TTRACE(PropL_prior,sdPropL_prior)
  !! LPropL_prior = logit((const double&)PropL_prior);
  !! varLPropL_prior = square(logit((const double&)sdPropL_prior));
  !! TTRACE(LPropL_prior,varLPropL_prior)
...
PARAMETER_SECTION
  ...
  // Schaefer parameters
  // MSY parameterization of logistic parameters
...
SEPARABLE_FUNCTION void step0(const dvariable& p11, const dvariable p21, const dvariable& lsdlogPop, const dvariable& lFmsy, const dvariable& lMSY);
...
SEPARABLE_FUNCTION void step(const int t, const dvar_vector& f1, const dvar_vector& f2, const dvariable& lsdlogF, const dvariable& p11, const dvariable p12, const dvariable& p21, const dvariable p22, const dvariable& lsdlogPop, const dvariable& lFmsy, const dvariable& lMSY, const dvariable& lT12, const dvariable& lT21,const dvariable& qP)
  ...
  dvariable PLnll;
  if ( (use_PropL_prior) && (years(t) >= PropL_start_time))
  {
     dvariable LPropL = nextLogN1 - nextLogN2;
     PLnll += 0.5*(log(TWO_M_PI*varLPropL_prior) + square(LPropL - LPropL_prior)/varLPropL_prior);
  }
