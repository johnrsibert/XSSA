...
{\sffamily
Model A\\
\includegraphics[width=1.00\textwidth]{../4-gear-runs/r2/mcmc/posterior_row.pdf}\\
~\\
Model B\\
\includegraphics[width=1.00\textwidth]{../4-gear-runs/r4/mcmc/posterior_row.pdf}\\
~\\
Model C\\
\includegraphics[width=1.00\textwidth]{../4-gear-runs/r0-sdrprior/mcmc/posterior_row.pdf}\\
}
\end{center}
