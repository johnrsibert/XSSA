...
%stock in the Main Hawaiian Islands Yellowfin Tuna Fishery}
\title{Assessment of a fragment of the yellowfin tuna 
({\it Thunnus albacares}) stock in the Pacific~Ocean:\\[0.125in]
...
\pagestyle{headings}
\markright{Status of the {\rm Ahi} stock in Hawai`i \hfil John Sibert}
...
Yellowfin ({\it Thunnus albacares}, YFT) tuna is an important food resource
...
Offine coupling is used to link the local biomass to regional
...
The model is applied to the 65 year catch time series collected by the
State of Hawaii.
...
catch by 4 fishing gears from 1952 through 2012
(Figure~\ref{fig:data}).
Data preparation is described in Appendix~\ref{sec:data}.
All computer code, data files, and draft reports presented in this
...
\begin{figure}
\begin{center}
%\includegraphics[width=0.95\textwidth]{../4-gear-runs/multiOPcatch.pdf}
\includegraphics[height=0.45\textheight]{../4-gear-runs/multiOPcatch.pdf}
...
\\
\includegraphics[width=0.33\textwidth]{../4-gear-runs/r2/est_popB1.pdf} &
\includegraphics[width=0.33\textwidth]{../4-gear-runs/r4/est_popB1.pdf} &
\includegraphics[width=0.33\textwidth]{../4-gear-runs/r0-sdrprior/est_popB1.pdf}\\
\end{tabular}
}
...
estimate that region 2 has experienced relatively a minor
impact of the fishery.
In contrast, region 4 hosts some of the largest fisheries in the WCPO and
...
actually take on this challenging project.
...
%It is a fairly common practice, but does usually not propagate the
%estimation errors between the two models.
...
\includegraphics[height=0.45\textheight]{./graphics/MFCLregions.png}
...
An implicit assumption of selection a specific biomass time series for an
index of abundance for the MHI stock 
is that the ecology and productivity of the index population 
...
\begin{figure}
\begin{center}
%\includegraphics[width=\textwidth]{./graphics/paczones.pdf}
\includegraphics[height=0.45\textheight]{./graphics/paczones.pdf}
...
C. No index; $\sigma_r=0.2$ \\
\\
\includegraphics[width=0.30\textwidth]{../4-gear-runs/r2/prodB1.pdf} &
\includegraphics[width=0.30\textwidth]{../4-gear-runs/r4/prodB1.pdf} &
\includegraphics[width=0.30\textwidth]{../4-gear-runs/r0-sdrprior/prodB1.pdf}\\
\end{tabular}
}
...
$\pm 2\sigma_Y$.
Ordinates scaled to for each gear type.
...
& Fishing Mortality\\
\hline
\includegraphics[width=0.30\textwidth]{../4-gear-runs/r2/est_FB1.pdf} &
\includegraphics[width=0.30\textwidth]{../4-gear-runs/r4/est_FB1.pdf} &
\includegraphics[width=0.30\textwidth]{../4-gear-runs/r0-sdrprior/est_FB1.pdf}\\
\\
& Observed and Predicted Catch\\
\hline
\includegraphics[width=0.30\textwidth]{../4-gear-runs/r2/est_catchB1.pdf} &
\includegraphics[width=0.30\textwidth]{../4-gear-runs/r4/est_catchB1.pdf} &
\includegraphics[width=0.30\textwidth]{../4-gear-runs/r0-sdrprior/est_catchB1.pdf}\\
\end{tabular}
}
...
\label{sec:klingon}
The Main Hawaiian Islands supports a large number of non-commercial
fishers. There is no catch reporting and no mandatory marine fishing
license. In consequence it is difficult to accurately estimate the
noncommercial catch. 
...
Tables~\ref{tab:k2} and Tables~\ref{tab:k0} summarize the results of
attempting to fit the catch data with non-commercial catch included as
different multiples of the total catch. Four different multipliers
were tested, 1, 2, 5, and 10 times total catch.

All 8 augmented catch models converged to a solution. The negative
log likelihood values are higher than the non-augmented fits as would
be expected because there are more data points.
...
The details of the results of augmenting the catch depned strongly on
the model constraints, i.e., the index of abundance and the prior on
$r$.
...
prior on $r, \sigma_r = 0.8$, model A in Table~\ref{tab:ests1}.
\label{tab:k2}}
\begin{center}
...
$\bar{Y}_5$ & 818 & 1620 & 2420 & 4820 & 8810\\
\hline
\end{tabular}
\end{center}
}
...
prior on $r, \sigma_r = 0.2$, model C in Table~\ref{tab:ests1}.
\label{tab:k0}}
\begin{center}
\begin{tabular}{|l|r|rrrr|}
\hline
Multiplier & C & 1 & 2 & 5 & k10\\
\hline
\hline
...
$\bar{Y}_5$ & 818 & 1630 & 2050 & 4850 & 7490\\
\hline
\end{tabular}
\end{center}
}
