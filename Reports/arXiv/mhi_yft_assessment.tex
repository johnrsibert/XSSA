...
$\sigma_F$ & Fishing mortality random walk process error standard deviation (\peryr).\\
...
$\bar{F}_5$ & Average of total estimated fishing mortality for the most recent five years (mt).\\
\hline
...
$\sigma_r$  & Assumed standard deviation of $r$ around its prior,\\
            & fixed at $\sigma_r=0.8$ or $\sigma_r=0.1$.\\
...
Models without an index of abundance do not fit the data well, do
not converge to solutions as indicated by the values of $-\log L$
and $|G|_{max}$, and biomass estimates crash early in the time series.
...
\hline
\hline
$-\log L$ & 157.54 & 128.73 & 523.74 & 170.78 & 130.36 & 317.43\\
$n$ & 6 & 6 & 5 & 6 & 6 & 5\\
$|G|_{max}$ & 9.04e-06 & 2.1e-05 & 0.266 & 6.86e-05 & 3.43e-05 & 0.454\\
\hline
$\MSY$ & 1180 & 765 & 3040 & 1030 & 928 & 1490\\
$\Fmsy$ & 0.0235 & 0.0815 & 0.248 & 0.207 & 0.225 & 0.239\\
$Q$ & 0.438 & 0.00699 & 0.286 & 0.025 & 0.00288 & 0.286\\
$\sigma_P$ & 0.111 & 0.0703 & 0.00204 & 0.167 & 0.0787 & 0.00366\\
...
$K$ & 1e+05 & 18800 & 24500 & 9970 & 8240 & 12500\\
...
\caption{Plot of predicted catch on observed catch for two different
models.
