...
\includegraphics[height=0.35\textheight]{./4-gear-runs_r2-sdrprior_est_popB1.pdf} &
\includegraphics[height=0.35\textheight]{./4-gear-runs_r4-sdrprior_est_popB1.pdf} \\
\end{tabular}
}
