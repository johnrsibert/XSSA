...
\hypersetup{pdfkeywords={yellowfin,state space,transfer model,Hawaii}}
...
\markright{Sibert\hfil {\bf DRAFT}\hfil MHI Assessment Model\hfil\today}
...
population was pawned reared in the MHI (Wells et al 2012).
The average annual catch of YFT in the MHI from 2008 through 2012 by Hawaii
based fleets was approximately 814 mt. 
Although the MHI fishery is quite small in comparison to the
current 550,000 mt WCPO catch (Davies, at al 2014)
and is embedded in a much larger
...
interact identically with the fishing gear in region 1.
...
(WCPFC) stock assessment (Davies et al 2014) from 1952 through 2012.
\end{enumerate}
...
\begin{figure}
\begin{center}
\includegraphics[width=1.00\textwidth]{./graphics/NNts.pdf}
...
\section*{Model feasibility and Next steps}
