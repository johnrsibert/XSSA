...
\markright{Sibert\hfil MHI Comparment Model\hfil{\bf INTERIM}\hfil\today}
...
under this model is
\begin{equation}
C_{g,t} = F_{g,t}\cdot\Bigl(\frac{\None_{t-\Delta t}+\None_t}{2}
                           +\frac{\Ntwo_{t-\Delta t}+\Ntwo_t}{2}\Bigr)
\label{eqn:catcheqn}
\end{equation}
