...
yield, and increasing the weight at first recapture would decrease the
total yield.
...
%\help{It should be possible to do a better
...
size restrictions in Region 4, and elsewhere in the equatorial
fishery.
...
US scientists should participate actively in  WCPFC pre-assessment
workshops with a mandate to assist the assessment team find ways to
include 
data from all Hawaii fisheries in the assessment and to redefine the MFCL
...
The HTTP data should be completely reanalyzed, and yellowfin
tag returns after 2001 should be included in the data.

\item The WCPFC convention area stock assessment is unsuitable for
addressing sub-regional management issues.

NOAA or academic fisheries scientists should be encouraged to develop
suitable models for the assessment of stocks in the Hawaii EEZ.
