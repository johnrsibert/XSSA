...
parameter estimation is hindered by possible lack of information in
the data.
\end{abstract}
...
It is not clear shere creating stock assessment model
...
Note the nonlinear mortality term $2r\frac{\None\Ntwo}{K}$ generated
by two subpopulations constrained by the same logistic process.
...
important non-linearity in the model that predicts a potential
