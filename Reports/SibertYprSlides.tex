...
\begin{slide}\section{Hypothetical Region 2 Fishing Mortality}
\begin{center}
\includegraphics[height=0.85\textheight]{./graphics/YPR_BOGUS_4_5.pdf}
\end{center}
\end{slide}

\begin{slide}\section{NOAA Weight-Frequency Data, 2000 -- 2013}
\begin{center}
\includegraphics[height=0.85\textheight]{./graphics/qwf.pdf}
\end{center}
\end{slide}
...
\item Available data on size distribution of commercial catch does not
show a large catch of small fish.
...
\item Collect relevant catch and size data that represent the fishery.
...
\begin{center}
\includegraphics[height=0.85\textheight]{./graphics/5_gear_catch_history_q.pdf}
\end{center}
\end{slide}

\begin{slide}\section{NOAA Weight-Frequency Data, 2000 -- 2013}
\begin{center}
\includegraphics[height=0.85\textheight]{./graphics/whole_wt_all.pdf}
\end{center}
\end{slide}
